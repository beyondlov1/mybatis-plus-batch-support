...
/**
 * @author: chenshipeng // TODO
 * @date: 2020/06/20
 */
public class UpdateNotNullColumnsBatchById extends AbstractMethod {
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        return this.addInsertMappedStatement(mapperClass, modelClass, CustomSqlMethod.UPDATE_NOT_NULL_COLUMNS_BATCH.getMethod(), sqlSource, keyGenerator, keyProperty, keyColumn);
    }

    private String getBatchUpdateSql(TableInfo tableInfo) {
        String batchInsertSql = CustomSqlMethod.UPDATE_NOT_NULL_COLUMNS_BATCH.getSql();
